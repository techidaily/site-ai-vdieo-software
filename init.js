...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Giselle';
const subSiteKeywords = `ai video, ai video editor, ai video editing, ai video software, ai video soft` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = '0facec5106534e1fbbc18ef421225846'; // 替换为你的API密钥
